...
set output "merge_sort_float.pdf" 
...
set title "Merge sort float" font "Bold,10" offset -1.0,-3.5
set size 0.4,0.7
plot "mergesort.dat" using 1:3 notitle with linespoint lw 2 ps 0.25,\
