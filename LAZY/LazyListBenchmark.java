...
public class LazyListBenchmark {
    ...
    private static void fillList(LazyList list, int size) {
    ...
    private static long runSequentially(LazyList list, int[] workload, int keysRange) {
        Random random = new Random();
    ...
    private static long runConcurrently(LazyList list, int[] workload, int keysRange, int threads) {
        Random random = new Random();
        int numContains = workload[0];
        int numInserts = workload[1];
        int numDeletes = workload[2];
