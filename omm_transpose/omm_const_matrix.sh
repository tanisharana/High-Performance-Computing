...
set output "omm_constmatrix.pdf" 
...
set title "omm Constant Matrix Size\n" font "Bold,7" offset -1.0,-3.5
set size 0.4,0.7
plot "omm_const_matrix.dat" using 1:2 title "512" with linespoint lw 2 ps 0.25,\
"omm_const_matrix.dat" using 1:3 title "1024" with linespoint lw 2 ps 0.25,\
"omm_const_matrix.dat" using 1:4 title "2048" with linespoint lw 2 ps 0.25,\
