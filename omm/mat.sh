...
set size 0.22,0.5
plot "gnuplot_data.dat" using 1:2 title "512" with linespoint lw 2 ps 0.25,\
"gnuplot_data.dat" using 1:3 title "1024" with linespoint lw 2 ps 0.25,\
"gnuplot_data.dat" using 1:4 title "2048" with linespoint lw 2 ps 0.25,\
...
set size 0.22,0.5
plot "gnu_constThread.dat" using 1:2 title "1" with linespoint lw 2 ps 0.25,\
"gnu_constThread.dat" using 1:3 title "2" with linespoint lw 2 ps 0.25,\
"gnu_constThread.dat" using 1:4 title "4" with linespoint lw 2 ps 0.25,\
"gnu_constThread.dat" using 1:5 title "8" with linespoint lw 2 ps 0.25,\
"gnu_constThread.dat" using 1:6 title "16" with linespoint lw 2 ps 0.25,\
